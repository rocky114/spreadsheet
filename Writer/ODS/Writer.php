...
namespace Rocky114\Excel\Writer\ODS;

use Rocky114\Excel\Writer\Common\Entity\Options;
use Rocky114\Excel\Writer\WriterMultiSheetsAbstract;
...
class Writer extends WriterMultiSheetsAbstract
{
     ...
     * @throws \Rocky114\Excel\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened
     * @return Writer
     */
