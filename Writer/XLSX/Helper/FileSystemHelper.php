...
namespace Rocky114\Excel\Writer\XLSX\Helper;

use Rocky114\Excel\Writer\Common\Entity\Worksheet;
use Rocky114\Excel\Writer\Common\Helper\FileSystemWithRootFolderHelperInterface;
 ...
 */
class FileSystemHelper extends \Rocky114\Excel\Common\Helper\FileSystemHelper implements FileSystemWithRootFolderHelperInterface
{
    ...
    /** @var \Rocky114\Excel\Common\Helper\Escaper\XLSX Used to escape XML data */
    private $escaper;
     ...
     * @param \Rocky114\Excel\Common\Helper\Escaper\XLSX $escaper Used to escape XML data
     */
     ...
     *
     * @throws \Rocky114\Excel\Common\Exception\IOException If unable to create the folder
     ...
     *
     * @throws \Rocky114\Excel\Common\Exception\IOException If unable to create the folder or the ".rels" file
     * @return FileSystemHelper
     */
     ...
     *
     * @throws \Rocky114\Excel\Common\Exception\IOException If unable to create the file
     * @return FileSystemHelper
     */
...
EOD;
     ...
     *
     * @throws \Rocky114\Excel\Common\Exception\IOException If unable to create the folder or one of the files
     * @return FileSystemHelper
     */
...
EOD;
     ...
     *
     * @throws \Rocky114\Excel\Common\Exception\IOException If unable to create at least one of the folders
     * @return FileSystemHelper
     */
