...
use Rocky114\Excel\Reader\Exception\IteratorNotRewindableException;
...
class RowIterator implements IteratorInterface
{
     ...
     *
     * @throws \Rocky114\Excel\Reader\Exception\IteratorNotRewindableException If the iterator is rewound more than once
     * @return void
     */
    ...
    /**
     * @param \Rocky114\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-row>" starting node
    ...
    /**
     * @param \Rocky114\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<table:table-cell>" starting node
     * @return int A return code that indicates what action should the processor take next
     */
