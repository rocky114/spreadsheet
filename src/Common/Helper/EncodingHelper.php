...
use Rocky114\Excel\Common\Exception\EncodingConversionException;
...
class EncodingHelper
{
    ...
    /**
     * @param \Rocky114\Excel\Common\Helper\GlobalFunctionsHelper $globalFunctionsHelper
     */
     ...
     * @throws \Rocky114\Excel\Common\Exception\EncodingConversionException If conversion is not supported or if the conversion failed
