...
class StyleManager
{
     ...
     *
     * @param \Rocky114\Excel\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on the "numFmts" node
     * @return void
     */
     ...
     *
     * @param \Rocky114\Excel\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on the "cellXfs" node
     * @return void
     */
