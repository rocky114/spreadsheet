...
use Rocky114\Excel\Reader\XLSX\Creator\HelperFactory;
...
use Rocky114\Excel\Reader\XLSX\Manager\SharedStringsCaching\CachingStrategyInterface;
...
class SharedStringsManager
{
     ...
     *
     * @throws \Rocky114\Excel\Common\Exception\IOException If shared strings XML file can't be read
     * @return void
     */
     ...
     *
     * @param \Rocky114\Excel\Reader\Wrapper\XMLReader $xmlReader XMLReader instance
     * @throws \Rocky114\Excel\Common\Exception\IOException If sharedStrings.xml is invalid and can't be read
     ...
     *
     * @param \Rocky114\Excel\Reader\Wrapper\XMLReader $xmlReader XML Reader positioned on a "<si>" node
