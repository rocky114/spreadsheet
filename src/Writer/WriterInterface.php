...
interface WriterInterface
{
     ...
     * @throws \Rocky114\Excel\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
     ...
     * @throws \Rocky114\Excel\Common\Exception\IOException If the writer cannot be opened
     * @return WriterInterface
     */
     ...
     * @throws \Rocky114\Excel\Writer\Exception\WriterNotOpenedException If the writer has not been opened yet
     * @throws \Rocky114\Excel\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
     ...
     * @throws \Rocky114\Excel\Common\Exception\InvalidArgumentException If the input param is not valid
     * @throws \Rocky114\Excel\Writer\Exception\WriterNotOpenedException If the writer has not been opened yet
     * @throws \Rocky114\Excel\Common\Exception\IOException If unable to write data
     * @return WriterInterface
     */
